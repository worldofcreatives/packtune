...
# Associations
creator_genre_table = db.Table(add_prefix_for_prod('creator_genres'),
...
creator_type_table = db.Table(add_prefix_for_prod('creator_types'),
    db.Column('creator_id', db.Integer, db.ForeignKey(add_prefix_for_prod('creators.id')), primary_key=True),
    db.Column('genre_id', db.Integer, db.ForeignKey(add_prefix_for_prod('types.id')), primary_key=True)
)

opp_genre_table = db.Table(add_prefix_for_prod('opp_genres'),
